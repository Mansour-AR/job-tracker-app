...
const DeleteConfirmationModal = ({ isOpen, onClose, onConfirm, jobTitle, loading }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-2 md:p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-sm md:max-w-md w-full border border-gray-200">
        <div className="p-4 md:p-6">
          <div className="flex items-center mb-4">
            <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-red-100 rounded-full flex items-center justify-center mr-3 md:mr-4">
          ...
          <div className="flex gap-2 md:gap-3">
            ...
            <button
              type="button"
              onClick={onConfirm}
              className="flex-1 bg-red-600 text-white py-2 md:py-2.5 rounded-lg font-semibold text-sm md:text-base hover:bg-red-700 transition-colors flex items-center justify-center"
              disabled={loading}
            >
              {loading ? (
                <>
